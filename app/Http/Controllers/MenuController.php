...
class MenuController extends BaseController
{
    ...
    public function getMenuItems()
    {
        ...
        foreach ($menuItems as $menuItem) {
            $nestedMenuItem = $this->buildNestedMenuItem($menuItem);
    ...
    private function buildNestedMenuItem($menuItem)
    {
        $nestedMenuItem = $menuItem->toArray();
        $nestedMenuItem['children'] = [];

        foreach ($menuItem->children as $childMenuItem) {
            $nestedChildMenuItem = $this->buildNestedMenuItem($childMenuItem);
            $nestedMenuItem['children'][] = $nestedChildMenuItem;
        }
